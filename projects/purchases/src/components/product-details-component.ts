...
export class ProductDetailComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.productdetailsform = this.fb.group({
      ...
      retailPrice: [
        this.productdetails?.retailPrice,
        (this.productdetails?.saleable) ? [Validators.required, Validators.min(1)] : []
      ],
      wholesalePrice: [
        this.productdetails?.wholesalePrice,
        (this.productdetails?.saleable) ? [Validators.required, Validators.min(1)] : []
      ],
      wholesaleQuantity: [this.productdetails?.wholesaleQuantity],
      amount: [''],
    });
  }
